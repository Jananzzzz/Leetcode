...
class Solution:
    def licenseKeyFormatting(self, s: str, k: int) -> str:
        ...
        for i in range(num):
            res += "-"
            res += s[lead+i*k: lead+i*k+k] 
        return res if lead != 0 else res[1:]

print(Solution.licenseKeyFormatting(Solution(), s = "2-5g-3-J", k = 2))
print(Solution.licenseKeyFormatting(Solution(), s = "5F3Z-2e-9-w", k = 4))
