...
the timer for it is reset, and the poison effect will end duration seconds after the 
new attack.
...
print(Solution.findPoisonedDuration(Solution(), timeSeries = [1,2], duration = 2))