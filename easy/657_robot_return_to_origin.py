...
Given a sequence of its moves, judge if this robot ends up at (0, 0) after it completes its
 moves.
...
class Solution:
    def judgeCircle(self, moves: str) -> bool:
        move_list = [i for i in moves]
        return move_list.count('L') == move_list.count('R') and \
        move_list.count('U') == move_list.count('D')

print(Solution.judgeCircle(Solution(), moves='UD'))